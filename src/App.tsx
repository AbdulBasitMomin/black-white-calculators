    ...
    <SidebarProvider defaultOpen={false}>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900 safe-area-inset-left safe-area-inset-right">
        ...
        <div className="flex-1 flex flex-col">
          <header className="sticky top-0 z-40 border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 safe-area-inset-top header-stable">
            <div className="flex items-center justify-between w-full h-full px-4 gap-4">
              <div className="flex items-center gap-4 min-w-0 flex-1">
                <SidebarTrigger className="header-button-stable rounded-lg hover:bg-accent transition-colors" />
